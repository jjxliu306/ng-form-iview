<template>
	<div v-if="!renderPreview || isDragPanel"> 
		...
		<Select class="width-select" v-model="dataForm.province" value-key="value" filterable clearable placeholder="请选择省份" @on-change="changeProvince" @on-clear="changeProvince()" :disabled="disabled"> 
    ...
    <Select v-if="record.options.maxLevel >1 && (!record.options.oneByOne || dataForm.province)" class="width-select" v-model="dataForm.city" value-key="value" filterable clearable  placeholder="请选择地市" @on-change="changeCity" @on-clear="changeCity()" :disabled="disabled">
    ...
    <Select v-if="record.options.maxLevel > 2 && (!record.options.oneByOne || dataForm.city)" class="width-select" v-model="dataForm.district" value-key="value" filterable clearable placeholder="请选择区县" @on-change="changeDistrict" @on-clear="changeDistrict()" :disabled="disabled"> 
